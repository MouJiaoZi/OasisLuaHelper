...
---@field FadeInDistanceStart number
---@field FadeInDistanceEnd number
---@field FadeOutDistanceStart number
---@field FadeOutDistanceEnd number
---@field Volume number
FDistanceDatum = {}
...
---@field CrossFadeInput ULuaArrayHelper<FDistanceDatum> @Each input needs to have the correct data filled in so the SoundNodeDistanceCrossFade is able to determine which sounds to play
