...
---@field CooldownDuration number @Value we will add or set to the Cooldown tag when this node is deactivated.
...
---@field bActivatesCooldown boolean @Whether or not we are adding/setting to the cooldown tag's value when the decorator deactivates.
