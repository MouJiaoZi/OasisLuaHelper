---@class TeamAthleticsResultItem_UIBP_C:UUAEUserWidget
...
---@field TextBlock_TC_Assist UTextBlock
---@field TextBlock_TC_Kill UTextBlock
---@field TextBlock_TC_Rate UTextBlock
---@field TextName UTextBlock
---@field WidgetSwitcher_Result_Gender UWidgetSwitcher
---@field WidgetSwitcher_ResultI_MVP UWidgetSwitcher
