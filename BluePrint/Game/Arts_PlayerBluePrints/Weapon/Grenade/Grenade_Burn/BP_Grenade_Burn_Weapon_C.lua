---@class BP_Grenade_Burn_Weapon_C:ASTExtraWeapon_Throw
---@field DestroyFireFlame:fun()
---@field CreateFireFlame:fun()
---@field UpdateFireScaleInternal:fun()
---@field GetBurningFireFX:fun():UParticleSystemComponent
---@field GetSkillEntryForMeleeWeapon:fun(IsPressed:bool):EUTSkillEntry
---@field UserConstructionScript:fun()
---@field BP_Grenade_Burn_Weapon_AnimList BP_Grenade_Burn_Weapon_AnimList_C
