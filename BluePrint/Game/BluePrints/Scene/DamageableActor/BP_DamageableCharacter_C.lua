---@class BP_DamageableCharacter_C:ADamageableCharacter
...
---@field OnCurrentHpReachedZeroByAnyDamage__DelegateSignature:fun(Sender:BP_DamageableCharacter_C,Damage:float,DamageType:UDamageType,InstigatedBy:AController,DamageCauser:AActor)
---@field OnAnyDamage__DelegateSignature:fun(Sender:BP_DamageableCharacter_C,Damage:float,DamageType:UDamageType,InstigatedBy:AController,DamageCauser:AActor)
---@field MaxHp float
