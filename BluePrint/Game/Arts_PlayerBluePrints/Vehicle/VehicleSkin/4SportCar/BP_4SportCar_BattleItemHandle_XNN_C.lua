---@class BP_4SportCar_BattleItemHandle_XNN_C:UBackpackVehicleHandle
...
---@field Sfx_HoodOpen UAkAudioEvent
---@field Sfx_HoodClose UAkAudioEvent
---@field HoodOpenParticleName FName
---@field HoodCloseParticleName FName
