...
---@field Density number @Density - 0.0 < 0.85 < 1.0 - Coloration of the late reverb - lower value is more grainy
---@field Diffusion number @Diffusion - 0.0 < 0.85 < 1.0 - Echo density in the reverberation decay - lower is more grainy
...
function USubmixEffectReverbPreset:SetSettingsWithReverbEffect(InReverbEffect, WetLevel) end
