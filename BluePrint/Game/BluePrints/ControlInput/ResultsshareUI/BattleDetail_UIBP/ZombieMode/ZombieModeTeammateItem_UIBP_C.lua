---@class ZombieModeTeammateItem_UIBP_C:UUAEUserWidget
...
---@field GridPanel_InjuredNum UGridPanel
...
---@field TextBlock_InjuredNum UTextBlock
---@field TextBlock_KillAnimal UTextBlock
