...
---@field OnFinished FTaskFinishDelegate @called when child task finishes execution before time runs out
---@field OnTimeExpired FTaskFinishDelegate @called when time runs out
